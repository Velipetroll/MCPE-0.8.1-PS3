...
void GuiComponent::blit(float x, float y, int32_t a4, int32_t a5, float a6, float a7, int32_t a8, int32_t a9){
	...
	v15 = (float)(v14+a5) * 0.0039062f;
	Tesselator::instance.vertexUV(x, y+a7, this->zLayer, (float)a4*0.0039062f, v15);
	v16 = (float)(v10+a4) * 0.0039062f;
	Tesselator::instance.vertexUV(x+a6, y+a7, this->zLayer, v16, v15);
	Tesselator::instance.vertexUV(x+a6, y, this->zLayer, v16, (float)a5*0.0039062f);
	Tesselator::instance.vertexUV(x, y, this->zLayer,(float)a4*0.0039062f, (float)a5*0.0039062f);
...
void GuiComponent::blit(int32_t x, int32_t y, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9){
	...
	v16 = (float) x;
	if(!a8) v13 = a6;
	Tesselator::instance.vertexUV(x, v15, this->zLayer, (float)a4*0.0039062f, (float)(a5+v14)*0.0039062f);
	v17 = (float)(x+a6);
	Tesselator::instance.vertexUV(v17, v15, this->zLayer, (float)(v13+a4)*0.0039062f, (float)(a5+v14)*0.0039062f);
	Tesselator::instance.vertexUV(v17, y, this->zLayer, (float)(v13+a4)*0.0039062f, (float)a5*0.0039062f);
	Tesselator::instance.vertexUV(v16, y, this->zLayer, (float)a4*0.0039062f, (float)a5*0.0039062f);
	Tesselator::instance.draw(1);
}
...
void GuiComponent::fillGradient(float a2, float a3, float a4, float a5, int32_t a6, int32_t a7){
	...
	glShadeModel(0x1D01);
	Tesselator::instance.begin(4);
	Tesselator::instance.color((float)((a6&0xff0000) >> 16)/255.0f, (float)((a6&0xff00) >> 8)/255.0f, (float)(a6&0xff)/255.0f, (float)((a6&0xff000000) >> 24)/255.0f);
	Tesselator::instance.vertex(a4, a3, 0);
	Tesselator::instance.vertex(a2, a3, 0);
	Tesselator::instance.color((float)((a7&0xff0000) >> 16)/255.0f, (float)((a7&0xff00) >> 8)/255.0f, (float)(a7&0xff)/255.0f, (float)((a7&0xff000000) >> 24)/255.0f);
	Tesselator::instance.vertex(a2, a5, 0);
	Tesselator::instance.vertex(a4, a5, 0);
	Tesselator::instance.draw(1);
	glShadeModel(0x1D00);
...
void GuiComponent::fillHorizontalGradient(float a2, float a3, float a4, float a5, int32_t a6, int32_t a7) {
	float v10 = (float)((a7 & 0xff000000) >> 24) / 255.0f;
	float v11 = (float)((a7 & 0x00ff0000) >> 16) / 255.0f;
	float v12 = (float)((a7 & 0x0000ff00) >> 8) / 255.0f;
	float v13 = (float)((a7 & 0x000000ff)) / 255.0f;
	float v14 = (float)((a6 & 0xff000000) >> 24) / 255.0f;
	float v15 = (float)((a6 & 0x00ff0000) >> 16) / 255.0f;
	float v16 = (float)((a6 & 0x0000ff00) >> 8) / 255.0f;
	float v17 = (float)((a6 & 0x000000ff)) / 255.0f;

	DisableState v18(0xDE1u);
	glShadeModel(0x1D01u);
	Tesselator::instance.begin(4);
	Tesselator::instance.color(v11, v12, v13, v10);
	Tesselator::instance.vertex(a4, a3, 0.0f);
	Tesselator::instance.color(v15, v16, v17, v14);
	Tesselator::instance.vertex(a2, a3, 0.0f);
	Tesselator::instance.color(v15, v16, v17, v14);
	Tesselator::instance.vertex(a2, a5, 0.0f);
	Tesselator::instance.color(v11, v12, v13, v10);
	Tesselator::instance.vertex(a4, a5, 0.0f);

	// CORREGIDO: Se eliminó el "instance.instance" redundante que rompía la compilación
	Tesselator::instance.draw(1);
